...
In this Project, I have calculated the total numbers of worldwide restaurant as KPI, i.e. 9551 out of which India has the maximum number of restaurant i.e. 8652 whereas Canada has the least number of restaurant i.e. only 4.
...
1. How many restaurants have availability online delivery on the worldwide basis ?
2. How many restaurants have same time delivery service on the worldwide basis ?
...
1. The total number of restaurants that have online delivery service is 2451 and rest 7100 restaurants don't have online delivery service.

2. The total number of restaurants that have same time delivery service is 34 and rest 9517 restaurants don't have same time delivery service.

3. The total number of restaurants that have table booking service is 1158 and rest 8393 restaurants don't have table booking service.
